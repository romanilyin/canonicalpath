...
- Added npm prepack notice sync so `LICENSE.md`, `LICENSE.ru.md`, and `NOTICE.md` are included in the published tarball without duplicating root legal files in source.
